  ...
  return (
    <div className='footer'>
        ...
        <div className="inPrint">
            ...
            <span className='name' > Success Hub Technology</span>
            <span className="icons">
                <a className='link' href="https://wa.me/+2349059309831?text=Hello, success hub cantacting you from rilzain solutions Website"><WhatsAppIcon /></a>
                <a className='link' href="tel:+2349059309831"><PhoneIcon /></a>
            </span>
        </div>
    </div>
  )
